...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        %              '-M',2,'-D',10)
            ...
            obj.Set();
            proStr = {'N','M','D','algorithm','problem','operator','evaluation','run','mode','outputFcn','data'};
            if nargin > 0
        ...
        function notermination = NotTermination(obj,Population, time)
    ...
    methods(Access = private, Static)
        ...
        function save(obj)
            %clc; 
            fprintf('%s on %s, %d objectives, run %d (%6.2f%%), %.2fs passed...\n',...
        ...
        function show(obj)
            ...
            fprintf('%s on %s, %d objectives, run %d (%6.2f%%), %.2fs passed...\n',...
                         func2str(obj.algorithm),func2str(obj.problem),obj.M,obj.run,obj.evaluated/obj.evaluation*100,obj.runtime);
            if 0%obj.evaluated > obj.evaluation
