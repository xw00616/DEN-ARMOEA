function varargout = DTLZ5IM(Operation,Global,input)
% <problem> <DTLZ special>
% On Finding Pareto-Optimal Solutions Through Dimensionality Reduction for
% Certain Large-Dimensional Multi-Objective Optimization Problems
...
%--------------------------------------------------------------------------
    ...
    I = Global.ParameterSet(2);
    I = max(min(I,Global.M),2);
    switch Operation
        case 'init'
            Global.M          = 3;
            Global.D          = Global.M + 9;
